...
export const ALPHA_GATEWAY_ABI = Object.freeze([
    ...
    'function quoteBridgeOutWithFee(uint64 destSelector,address token,address recipient,uint256 mintedAmount,(address recipient,uint16 bps) integrator) view returns (uint256 fee,uint256 cut,uint256 amountCrossing)',
